...
class VoiceChatbot:
    def __init__(self):
        self.cohere = cohere.Client("WwfRY9Jpp7zIG2nrXqosL1kP4bOdGCCZxSzcVQIh")  # Replace with your actual Cohere API key
        self.elevenlabs = ElevenLabs(api_key="sk_94a890c23492229ad28fff026dd1c24cbb50bbc291ab6a17")  # Replace with your actual ElevenLabs API key
    ...
    def think(self, text):
        response = self.cohere.chat(model="command-r7b-arabic-02-2025",message=text,temperature=0.7,max_tokens=200, preamble=جاوب بلهجة سعودية فقط، جاوب بشكل مختصر، اسمك هو المساعد الذكي وقد صممك جودي")
